...
print("🚀 BROski Master Installation Wizard 🚀")
print("======================================")
...
if not config_path.exists():
    if example_config_path.exists():
        ...
        print("\n✓ Created config.json from example template")
    else:
...
if os.name == "nt":
    ...
    print("✓ Created quick-start batch files")
...
print("\n✅ BROski Master Installation Complete!")
print("\nTo start BROski Bot:")
if os.name == "nt":
