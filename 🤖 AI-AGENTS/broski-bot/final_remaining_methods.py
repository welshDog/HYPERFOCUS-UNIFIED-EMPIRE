...
def verify_dependencies(self):
    ...
    self.diagnostic_text.insert(tk.END, "📦 Checking Dependencies...\n\n")
    self.info_label.config(text="Checking required packages...")
    
    # Define required and optional packages
    required_packages = [
        {"name": "requests", "desc": "HTTP requests library"},
        {"name": "pandas", "desc": "Data analysis library"},
        {"name": "numpy", "desc": "Numerical computation library"}
    ]
    
    optional_packages = [
        {"name": "matplotlib", "desc": "Plotting library"},
        {"name": "psutil", "desc": "Process and system utilities"},
...
def show_system_info(self):
    ...
    try:
        ...
        try:
            ...
            self.diagnostic_text.insert(tk.END, "Hardware Information: (Install psutil for more details)\n")
            self.diagnostic_text.insert(tk.END, f"- CPU: {platform.processor()}\n\n")
